  ...
  return (
    <div className="relative w-full max-w-3xl mx-auto">
      ...
      <button
        ...
        className={`absolute top-1/2 left-0 transform -translate-y-1/2 px-2 py-1 rounded-full shadow ${
      ...
      <button
        ...
        className={`absolute top-1/2 right-0 transform -translate-y-1/2 px-2 py-1 rounded-full shadow ${
